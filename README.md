...
- Ensure two different apps (need two unique Java package names in manifest and source for activity) can co-exist
  ...
  - Leave a skeleton activity in chewielouie.textadventure and chewielouie.textadventure2 which inherit from TextAdventureCommonActivity which has an abstract method for getting the 'R' class - getRClass()
